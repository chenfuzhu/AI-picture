...
import com.chenfuzhu.aipicturebackend.manager.FileManager;
import com.chenfuzhu.aipicturebackend.model.dto.file.UploadPictureResult;
import com.chenfuzhu.aipicturebackend.model.dto.picture.PictureQueryRequest;
import com.chenfuzhu.aipicturebackend.model.dto.picture.PictureReviewRequest;
...
import com.chenfuzhu.aipicturebackend.model.enums.PictureReviewStatusEnum;
import com.chenfuzhu.aipicturebackend.model.vo.PictureVO;
import com.chenfuzhu.aipicturebackend.model.vo.UserVO;
import com.chenfuzhu.aipicturebackend.service.PictureService;
import com.chenfuzhu.aipicturebackend.mapper.PictureMapper;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture> implements PictureService {
    ...
    public PictureVO uploadPicture(MultipartFile multipartFile, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        if (pictureId != null) {
            ...
            ThrowUtils.throwIf(oldPicture == null, ErrorCode.NOT_FOUND_ERROR, "The picture is not exists");
            // 仅本人或管理员可编辑
    ...
    public QueryWrapper<Picture> getQueryWrapper(PictureQueryRequest pictureQueryRequest) {
        ...
        Long reviewId = pictureQueryRequest.getReviewerId();
    ...
    public PictureVO getPictureVO(Picture picture, HttpServletRequest request) {
        ...
        if (userId != null && userId > 0) {
            ...
            UserVO userVO = userService.transformUserVO(user);
    ...
    public Page<PictureVO> getPictureVOPage(Page<Picture> picturePage, HttpServletRequest request) {
        ...
        pictureVOList.forEach(pictureVO -> {
            ...
            pictureVO.setUser(userService.transformUserVO(user));
        });
    ...
    public void doPictureReview(PictureReviewRequest pictureReviewRequest, User loginUser) {
        ...
        if (oldPicture.getReviewStatus().equals(reviewStatus)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "Dont Review again.");
        }
        // 更新审核状态
    ...
    public void fillReviewParams(Picture picture, User loginUser) {
        if (userService.isAdmin(loginUser)) {
            ...
            picture.setReviewMessage("Admin pass by auto.");
